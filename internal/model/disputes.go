...
type Dispute struct {
	...
	InitiatorUserID   int64         `json:"initiator_user_id" gorm:"not null;index:idx_initiator_status_created,priority:1"`
	...
	HandlerUserID     *int64        `json:"handler_user_id" gorm:"index"`
